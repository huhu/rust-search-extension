var commandsIndex = {
    ...
    "book/zh": [
        ...
        ["【中文版】Rust Async Book", "https://huangjj27.github.io/async-book/"],
        ["【中文版】Rust Edition Guide Book", "https://www.rustwiki.org.cn/zh-CN/edition-guide"],
        ["【中文版 WIP】The Cargo Book", "https://www.rustwiki.org.cn/zh-CN/cargo"],
        ["【中文版】The Rust Cookbook", "https://www.rustwiki.org.cn/zh-CN/rust-cookbook"],
        ["【中文版】Rust by Example", "https://www.rustwiki.org.cn/zh-CN/rust-by-example"],
        ["【中文版】The Rust Doc Book", "https://www.rustwiki.org.cn/zh-CN/rustdoc"],
        ["【中文版 WIP】The rustc Book", "https://www.rustwiki.org.cn/zh-CN/rustc"],
        ["【中文版 WIP】Guide to Rustc Development", "https://rustcrustc.github.io/rustc-dev-guide-zh/"],
        ["【中文版】The Rust Reference", "https://www.rustwiki.org.cn/zh-CN/reference"],
        ...
        ["【中文版】Rust 标准库文档", "https://www.rustwiki.org.cn/zh-CN/std/"],
    ...
    "cargo": [
        ...
        [
            "cargo-asm, cargo-llvm-ir",
            "https://github.com/gnzlbg/cargo-asm",
            "Shows generates assembly or LLVM IR of Rust code"
        ],
        [
            "cargo-benchcmp",
            "https://github.com/BurntSushi/cargo-benchcmp",
            "Compare output of cargo bench output, both runs over time and same benchmarks in multiple modules (e.g. for comparing multiple implementations)"
        ],
        [
            "cargo-bitbake",
            "https://github.com/cardoe/cargo-bitbake",
            "Generate Yocto's bitbake recipes from your Cargo.toml"
        ],
        [
            "cargo-bloat",
        ...
        [
            ...
            "Helps you manage the cargo cache (~/.cargo), print sizes and clear directories"
        ],
        [
            "cargo-check",
        ...
        [
            "cargo-cook",
            "https://github.com/vityafx/cargo-cook",
            "Cooks your crate (packaging & deploying)."
        ],
        [
            "cargo-clippy",
            "https://github.com/Manishearth/rust-clippy#as-a-cargo-subcommand-cargo-clippy",
            "Lint your project using Clippy."
        ],
        [
            "cargo-cln",
            "https://gitlab.com/pwoolcoc/cargo-cln",
            "Alternative to cargo-clean, allows running arbitrary commands in addition to wiping out target/ directory."
        ],
        [
            "cargo-clone",
            "https://github.com/janlikar/cargo-clone",
            "Fetch source code of a crate"
        ],
        [
            "cargo-config",
            "https://github.com/wesleywiser/cargo-config",
            "Print info about the current crate."
        ],
        [
            "cargo-count",
            "https://github.com/kbknapp/cargo-count",
            "counts lines of code in cargo projects, including giving naive unsafe statistics"
        ],
        [
            "cargo-deadlinks",
        ...
        [
            ...
            "Generates & builds Debian packages from cargo projects."
        ],
        [
            "cargo-deny",
        ...
        [
            ...
            "Create dependency diagrams for your Rust projects."
        ],
        [
            "cargo-diet",
        ...
        [
            ...
            "Run multiple cargo subcommands in sequence (e.g., cargo do clean, build)"
        ],
        [
            "cargo-dors",
            "https://github.com/aklitzke/dors",
            "Task runner for cargo. Deploy, load, or run other scripts from your cargo project"
        ],
        [
            "cargo-edit",
            "https://github.com/killercup/cargo-edit",
            "A utility for adding (cargo-add), removing (cargo-rm), and upgrading (cargo-upgrade) cargo dependencies from the command line."
        ],
        [
            "cargo-expand",
        ...
        [
            "cargo-funnel",
            "https://github.com/TomPridham/cargo-funnel",
            "Sorts and formats your Cargo.toml"
        ],
        [
            "cargo-fuzz",
        ...
        [
            ...
            "Create a new Rust project by leveraging a pre-existing git repository as a template."
        ],
        [
            "cargo-grammarly",
            "https://github.com/vityafx/cargo-grammarly",
            "Use the grammarly service for checking English grammar in your crate's documentation."
        ],
        [
            "cargo-graph",
            "https://github.com/kbknapp/cargo-graph",
            "Build GraphViz DOT files of dependency graphs. Unmaintained, consider using cargo-deps."
        ],
        [
            "cargo-info",
            "https://gitlab.com/imp/cargo-info",
            "Get crate information and details from crates.io"
        ],
        [
            "cargo-license",
            "https://github.com/onur/cargo-license",
            "List licensing info for the project's dependencies."
        ],
        [
            "cargo-linked",
            "https://github.com/JojiiOfficial/cargo-linked",
            "List Linked packages for a rust binary."
        ],
        [
            "cargo-lipo",
            "https://github.com/TimNN/cargo-lipo",
            "Automatically create universal libraries for iOS."
        ],
        [
            "cargo-lock",
            "https://github.com/RustSec/cargo-lock",
            "List packages, show dependency trees, and translate formats for Cargo.lock files."
        ],
        [
            "cargo-make",
        ...
        [
            ...
            "List a project's modules in a tree-like format."
        ],
        [
            "cargo-multi",
            "https://github.com/imp/cargo-multi",
            "Run a cargo command on multiple crates."
        ],
        [
            "cargo-next",
            "https://github.com/conventional-commits-rs/cargo-next",
            "Query or set the version of a crate."
        ],
        [
            "cargo-open",
            "https://github.com/carols10cents/cargo-open",
            "Quickly open your crate in your editor."
        ],
        [
            "cargo-outdated",
        ...
        [
            ...
            "Generate an Arch PKGBUILD for your crate."
        ],
        [
            "cargo-profiler",
            "https://github.com/svenstaro/cargo-profiler",
            "A cargo subcommand to profile your applications."
        ],
        [
            "cargo-release",
            "https://github.com/sunng87/cargo-release",
            "Standardizes the release process of a cargo project."
        ],
        [
            "cargo-repro",
            "https://github.com/rust-secure-code/cargo-repro",
            "Build and verify byte-for-byte reproducible Rust packages using a Cargo-based workflow (WIP)."
        ],
        [
            "cargo-rpm",
            "https://github.com/rustrpm/cargo-rpm",
            "Build RPM releases of Rust projects using cargo."
        ],
        [
            "cargo-sandbox",
            "https://github.com/rust-secure-code/cargo-sandbox",
            "Perform Cargo builds inside of a sandboxed environment (WIP)."
        ],
        [
            "cargo-script",
            "https://github.com/DanielKeep/cargo-script",
            "designed to let people quickly and easily run Rust \"scripts\" which can make use of Cargo's package ecosystem."
        ],
        [
            "cargo-sort-ck",
            "https://github.com/DevinR528/cargo-sort-ck",
            "Checks that your Cargo.toml dependencies are sorted alphabetically."
        ],
        [
            "cargo-tarpaulin",
            "https://github.com/xd009642/tarpaulin",
            "Code coverage tool for your Rust projects"
        ],
        [
            "cargo-tomlfmt",
        ...
        [
            ...
            "List a project's dependencies in a tree-like format. Also supports an \"inverted\" mode to help determine why a specific crate is being pulled in."
        ],
        [
            "cargo-update",
            "https://github.com/nabijaczleweli/cargo-update",
            "Check for cargo installed executables' newer versions and update as needed."
        ],
        [
            "cargo-urlcrate",
            "https://github.com/Aaron1011/cargo-urlcrate",
            "Adds URLs of installing/downloading crates to Cargo output"
        ],
        [
            "cargo-valgrind",
            "https://github.com/jfrimmel/cargo-valgrind",
            "Runs a binary, example, bench, ... inside valgrind to check for memory leaks. Helpful in FFI contexts."
        ],
        [
            "cargo-vendor",
            "https://github.com/alexcrichton/cargo-vendor",
            "Vendors all crates.io dependencies into a local directory using Cargo's support for source replacement"
        ],
        [
            "cargo-watch",
            "https://github.com/passcod/cargo-watch",
            "Watch your repo for changes and build automatically."
        ],
        [
            "cargo-whereis",
            "https://github.com/coriolinus/whereis",
            "Locate a particular crate within a workspace."
        ],
        [
            "cargo-with",
            "https://github.com/cbourjau/cargo-with",
            "A cargo-subcommand making it easy to run the build artifacts produced by cargo run or cargo build through other tools such as gdb, strace, valgrind, rr, etc."
        ],
        [
            "cargo-wix",
            "https://github.com/volks73/cargo-wix",
            "Builds a Windows installer (msi) using the Wix Toolset based on the contents of a package's manifest (Cargo.toml)"
        ],
        [
            "cargo-x",
