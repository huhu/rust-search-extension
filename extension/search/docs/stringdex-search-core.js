...
const searchRootPath = hooks.rootPath || ROOT_PATH;
if (typeof window !== "undefined" && !hooks.headless) {
    docSearch = new DocSearch(searchRootPath, database);
...
if (typeof window !== "undefined" && window.__RUSTDOC_SEARCH_AUTO_INIT__ !== false) {
